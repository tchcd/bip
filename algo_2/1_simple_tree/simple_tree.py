...
if __name__ == '__main__':
    ...
    #tree.AddChild(ParentNode=root, NewChild=n1)
    #tree.AddChild(ParentNode=n1, NewChild=n2)
    ...
    #tree.get_tree_level_with_values(root)
    ...
    #tree.get_tree_level_with_values(root, break_lvl=2)
    #tree.DeleteNode(n1)
    #print(tree.GetAllNodes())
    #print(tree.Count())
    #print(tree.LeafCount())
